                    ...
                    <div class="md:col-span-1">
                        <div class="bg-[#FFEBFA] rounded-xl p-4">
                            <div class="flex items-center gap-3 mb-4">
                                <div
                                    class="h-12 w-12 rounded-full bg-white border-2 border-[#D7C1D3] flex items-center justify-center">
                                    ...
                                    @for ($i = 1; $i <= 5; $i++)
                                        <label class="cursor-pointer">
                                            <input type="radio" name="rating" value="{{ $i }}"
                                                class="sr-only peer" {{ $review->rating == $i ? 'checked' : '' }}>
                                            <span
                                                class="text-3xl text-gray-300 star-icon hover:text-yellow-400 transition-colors duration-200"
                                                data-value="{{ $i }}">
