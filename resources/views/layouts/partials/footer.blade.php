<footer class="mt-auto w-full py-10 bg-[#FFEBFA] shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">

            <div class="col-span-full lg:col-span-1 flex flex-col items-center text-center">
                <a href="#" class="flex-none text-2xl text-black dark:text-black" aria-label="Brand">
                    <span class="font-normal text-5xl">Ticket</span><span class="font-bold text-5xl">Book</span>
                </a>

                <div class="pt-5 mt-5 w-full border-t border-black flex justify-center gap-4">
