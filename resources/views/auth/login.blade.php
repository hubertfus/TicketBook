...
@section('content')
    <div class="flex flex-1 justify-center items-center bg-[#FFEBFA] p-6 rounded-lg shadow-md">
        <div class="w-full max-w-md">
            <h2 class="text-2xl font-bold mb-6 text-center text-[#6B4E71]">Log in</h2>
            ...
            <div class="text-center text-sm text-[#3A4454] space-y-2 mt-6">
                <p>
                    ...
                    <a href="{{ url('/register') }}" class="text-[#6B4E71] hover:underline">Register</a>
                </p>
                <p>
                    <a href="{{ url('/forgot-password') }}" class="text-[#6B4E71] hover:underline">Forgot password?</a>
                </p>
            </div>
        </div>
    </div>
