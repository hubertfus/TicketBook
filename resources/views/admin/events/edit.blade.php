    ...
    <div class="max-w-xl mx-auto my-8">
        ...
        <form action="{{ route('events.update', $event) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="image" value="{{ $event->image }}" class="w-full border rounded p-2">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="status" value="{{ $event->status }}" class="w-full border rounded p-2"
                    required>
            </div>
            <div class="mb-4">
